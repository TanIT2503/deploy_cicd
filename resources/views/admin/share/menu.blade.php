<div class="horizontal-menu-wrapper">
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                        href="/assets_admin_vuxy/html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            <!-- include /assets_admin_vuxy/includes/mixins-->
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item" data-menu="dropdown"><a
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                            href="/admin/thong-ke" data-bs-toggle="" data-i18n="Analytics"><i
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/tai-khoan/index">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/history">
                        ...
                        <div class="menu-title">History driver</div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/tuyen/index">
                        <div class="parent-icon">
                            <i class="fa-solid fa-route"></i>
                        </div>
                        <div class="menu-title">Route Driver</div>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/xe/index">
                        ...
                        <div class="menu-title">List Car</div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/lich-trinh/index">
                        <div class="parent-icon">
